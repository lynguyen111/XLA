...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride=1):
        ...
        # Shortcut: cần projection nếu kích thước thay đổi
...
class Bottleneck(nn.Module):
    """Residual block cho ResNet-50, 101, 152 (dùng conv 1x1-3x3-1x1)."""
    ...
    def __init__(self, in_channels, out_channels, stride=1):
        ...
        # Conv 1x1 — tăng chiều trở lại (x4)
...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=13, dropout=0.4):
        super().__init__()
        self.in_channels = 64
