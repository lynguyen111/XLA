...
INSECT_CLASSES = {
    ...
    "Buom": ["butterfly insect", "con bướm", "beautiful butterfly", "monarch butterfly"],
...
def merge_images(class_name, queries, temp_dir, target_dir):
    ...
    if os.path.exists(target_dir):
        existing_files = [f for f in os.listdir(target_dir) if f.lower().endswith(valid_extensions)]
